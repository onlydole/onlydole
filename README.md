...
<p align="center">
  <a href="https://github.com/onlydole/onlydole.github.io/pull/12"><picture><source media="(prefers-color-scheme: dark)" srcset="assets/shipped-dark.svg"><img src="assets/shipped-light.svg" width="100%" alt="Recently shipped: Drop the scheduled writing refresh (merged · onlydole/onlydole.github.io · 2026-08-03); First-visit intro, OG/SEO coverage, podcast RSS feed, Episode 3 articles, full-screen artif… (merged · alexagriffith/attention-deficit · 2026-08-03); fix(security): object-level auth, CORS/session/secret hardening, dep CVEs (merged · onlydole/overdue · 2026-06-13)"></picture></a>
</p>
<p align="center">
...
<p align="center">
  <a href="https://www.goodreads.com/review/show/8828818083?utm_medium=api&amp;utm_source=rss"><picture><source media="(prefers-color-scheme: dark)" srcset="assets/reading-dark.svg"><img src="assets/reading-light.svg" width="100%" alt="Reading now: This Inevitable Ruin (Dungeon Crawler Carl, #7) (Matt Dinniman); You Can Just Do Things: How High-Agency People Get What They Want Out of Life (Cate Hall); Obviously Awesome: How to Nail Product Positioning so Customers Get it, Buy it, Love it (April Dunford)"></picture></a>
</p>
<p align="center">
...
<sub>⚡ <!-- stamp:start -->Last refreshed: 2026-08-04<!-- stamp:end --> · rebuilt daily by
