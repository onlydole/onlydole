...
<!-- bento:start -->
<a href="https://onlydole.dev"><picture><source media="(max-width: 600px) and (prefers-color-scheme: dark)" srcset="assets/hero-mobile-dark.svg"><source media="(max-width: 600px)" srcset="assets/hero-mobile-light.svg"><source media="(prefers-color-scheme: dark)" srcset="assets/hero-dark.svg"><img src="assets/hero-light.svg" width="100%" alt="Taylor Dolezal, Head of Open Source at Dosu, in Los Angeles. Building open source communities, making useful things, and sharing what I learn. Career so far: Disney Studios (Lead SRE), HashiCorp (Developer Advocate), CNCF (Head of Ecosystem), Dosu (Head of Open Source). Alongside: Kubernetes 1.19 lead, SIG Docs tech lead, KubeCon keynoter. The project is code. The work is people."></picture></a>
<p align="center">
...
<sub><!-- stamp:start -->Last refreshed: 2026-09-26<!-- stamp:end --> · refreshed every six hours by
