...
<p align="center">
  <a href="https://github.com/onlydole/awesome-knowledge-infrastructure/pull/4"><picture><source media="(prefers-color-scheme: dark)" srcset="assets/shipped-dark.svg"><img src="assets/shipped-light.svg" width="100%" alt="Recently shipped: Drop Substack self-promo; surface LanceDB near the top (merged · onlydole/awesome-knowledge-infrastructure · 2026-06-01); Expand and tighten the list; clean up curator attribution (merged · onlydole/awesome-knowledge-infrastructure · 2026-06-01); fix(workflow): raise doc-update max-turns to 25 (merged · onlydole/overdue · 2026-05-14)"></picture></a>
</p>
<p align="center">
